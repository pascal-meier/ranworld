...
export class LootyBoxUi {
    ...
    constructor(scene, goalScore, onTransparencyToggle = () => { }) {
        ...
        this.onTransparencyToggle = onTransparencyToggle;
        ...
        this.phaseDetail = scene.add
            ...
            .setOrigin(0.5);
        this.backButton = new Button(scene, width / 4, height * 0.1, "Back", () => scene.scene.start("MainMenuScene"));
        this.transparencyButton = new Button(scene, width * 0.8, height * 0.85, "Change Phase", () => this.onTransparencyToggle());
